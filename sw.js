...
const VERSION = 'arianna-v9';
const CORE = [
  './', 'index.html', 'styles.css?v=9', 'data.js?v=9', 'app.js?v=9',
  'images/avatar.jpg?v=9', 'manifest.webmanifest', 'favicon.png', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png'
];
