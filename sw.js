...
const VERSION = 'arianna-v10';
const CORE = [
  './', 'index.html', 'styles.css?v=10', 'data.js?v=10', 'app.js?v=10',
  'images/avatar.jpg?v=10', 'manifest.webmanifest', 'favicon.png', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png'
];
