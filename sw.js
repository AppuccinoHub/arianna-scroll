...
const VERSION = 'arianna-v11.1';
const CORE = [
  './', 'index.html', 'styles.css?v=11.1', 'data.js?v=11.1', 'app.js?v=11.1',
  'images/avatar.jpg?v=11.1', 'manifest.webmanifest', 'favicon.png', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png'
];
