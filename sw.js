...
const VERSION = 'arianna-v11.2';
const CORE = [
  './', 'index.html', 'styles.css?v=11.2', 'data.js?v=11.2', 'app.js?v=11.2',
  'images/avatar.jpg?v=11.2', 'manifest.webmanifest', 'favicon.png', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png'
];
