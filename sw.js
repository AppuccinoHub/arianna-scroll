...
const VERSION = 'arianna-v8';
const CORE = [
  './', 'index.html', 'styles.css?v=8', 'data.js?v=8', 'app.js?v=8',
  'images/avatar.jpg?v=8', 'manifest.webmanifest', 'favicon.png', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png'
];
