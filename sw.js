...
const VERSION = 'arianna-v6';
const CORE = [
  './', 'index.html', 'styles.css?v=6', 'data.js?v=6', 'app.js?v=6',
  'images/avatar.jpg?v=6', 'manifest.webmanifest', 'favicon.png', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png'
];
