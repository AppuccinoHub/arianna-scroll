...
const VERSION = 'arianna-v11.5';
const CORE = [
  './', 'index.html', 'styles.css?v=11.5', 'data.js?v=11.5', 'app.js?v=11.5',
  'images/avatar.jpg?v=11.5', 'manifest.webmanifest', 'favicon.png', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png'
];
